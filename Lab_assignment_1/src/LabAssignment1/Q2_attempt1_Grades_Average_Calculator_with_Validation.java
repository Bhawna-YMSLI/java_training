...
public class Q2_attempt1_Grades_Average_Calculator_with_Validation {
	public static void main(String []args) {
		...
		int grades[] = new int [numberOfStudents+1];
		...
		double average = (double) sum_grades / numberOfStudents ;
